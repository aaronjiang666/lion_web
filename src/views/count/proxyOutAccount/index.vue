      ...
      <el-row>
        <el-row class="search-row">
          ...
          <el-table :data="dataList" border header-cell-class-name="header-row">
            ...
            <el-table-column width="120" prop="channelName" label="支付通道" header-align="center" align="center" />
...
<script>
import { proxyOutAccount } from '@/api/pay/report'
...
export default {
  ...
  methods: {
    DataList() {
      ...
      proxyOutAccount(this.search).then(response => {
