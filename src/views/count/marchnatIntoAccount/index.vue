        ...
        <el-row class="search-row">
          ...
          <el-table :data="dataList" border header-cell-class-name="header-row">
            ...
            <el-table-column header-align="center" label="时间段内账目">
              ...
              <el-table-column width="160" sortable prop="intoMoney" label="结算金额(元)" header-align="center" >
                <template slot-scope="scope">
                  <span>{{ scope.row.intoMoney | CentToDollars }}</span>
                </template>
              </el-table-column>
              <el-table-column width="120" sortable prop="inPoundage" label="手续费(元)" header-align="center" >
                <template slot-scope="scope">
                  <span>{{ scope.row.inPoundage | CentToDollars }}</span>
                </template>
              </el-table-column>
            ...
            <el-table-column header-align="center" label="累计总账">
              ...
              <el-table-column width="120" sortable prop="addUpSurplusMoney" label="总余额(元)" header-align="center" >
                <template slot-scope="scope">
      ...
      <el-row>
        <el-col :span="24">
          <el-pagination
            ...
            :page-sizes="[5, 10, 20, 30, 40, 50, 100, 200, 300]"
...
<script>
import { getMarchnatIntoAccount } from '@/api/pay/report'
...
export default {
  ...
  methods: {
    DataList() {
      ...
      getMarchnatIntoAccount(this.search).then(response => {
